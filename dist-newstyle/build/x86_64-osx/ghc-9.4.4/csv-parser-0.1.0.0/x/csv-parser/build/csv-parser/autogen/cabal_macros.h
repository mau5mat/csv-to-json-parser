...
/* package csv-parser-0.1.0.0 */
#ifndef VERSION_csv_parser
#define VERSION_csv_parser "0.1.0.0"
#endif /* VERSION_csv_parser */
#ifndef MIN_VERSION_csv_parser
#define MIN_VERSION_csv_parser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_csv_parser */
...
#define CURRENT_COMPONENT_ID "csv-parser-0.1.0.0-inplace-csv-parser"
